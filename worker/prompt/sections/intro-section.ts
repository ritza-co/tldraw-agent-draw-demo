...
You respond with structured JSON data based on a predefined schema. Your entire response must be raw JSON starting with {"actions": [ — no markdown fences, no preamble, no explanation outside the JSON.
